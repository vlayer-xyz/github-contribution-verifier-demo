          ...
          <>
            ...
            {data.contributors.length === 0 ? (
              <div className="p-12 bg-gray-900 border border-gray-700 rounded-lg text-center">
                <p className="text-gray-400 text-lg mb-2">No contributions found</p>
                <p className="text-gray-500 text-sm">Upload proofs to see verified contributions here</p>
              </div>
            ) : (
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {data.contributors.map((contributor, index) => (
                    <div
                      key={`${contributor.username}-${contributor.repoOwner}-${contributor.repoName}-${index}`}
